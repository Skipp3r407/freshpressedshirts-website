...
export const galleryImages: GalleryImage[] = [
  ...
  {
    id: "rack-color",
    src: "https://images.unsplash.com/photo-1556821840-3a63d9569b57?auto=format&fit=crop&w=1200&q=82",
    alt: "Colorful printed shirts on hangers",
    title: "Event batch · multi-color",
    caption: "School fundraiser · 200+ pieces",
  },
  {
    id: "detail-neck",
    src: "https://images.unsplash.com/photo-1583743814966-8936f5bd7c1d?auto=format&fit=crop&w=1200&q=82",
    alt: "Close-up of t-shirt neckline and print",
    title: "Detail that sells",
    caption: "Ink sit & hand-feel check",
  },
  {
    id: "team-jersey",
    src: "https://images.unsplash.com/photo-1571945153237-4969f3aa43bc?auto=format&fit=crop&w=1200&q=82",
    alt: "Athletic and team shirts folded for delivery",
